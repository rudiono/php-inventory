...
session_start();
/**
 * Jika Tidak login atau sudah login tapi bukan sebagai gudang
 * maka akan dibawa kembali kehalaman login atau menuju halaman yang seharusnya.
 */
if ( !isset($_SESSION['user_login']) ||
    ( isset($_SESSION['user_login']) && $_SESSION['user_login'] != 'gudang' ) ) {
		...
		<div class="row">
			...
			<div class="row-fluid">
              ...
              <div class="caption">
                ...
                <p align="center">Melihat Data Barang</p>
                <p align="center"><a href="./../barang.php" class="btn btn-primary">Lihat Data</a></p>
              </div>
            </div>
					</div>
				<div class="col-xs-6 col-md-3">
					<div class="thumbnail">
            <div class="caption">
              <h3 align="center">Data Suplier</h3>
                <p align="center">Melihat Data Suplier Barang</p>
                <p align="center"><a href="./../suplier.php" class="btn btn-primary">Lihat Data</a> </p>
            </div>
          </div>
				</div>
				<div class="col-xs-6 col-md-3">
